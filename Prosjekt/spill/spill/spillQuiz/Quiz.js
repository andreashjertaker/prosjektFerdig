...
knapp.onclick = function finnPoeng() {
  ...
  if(antallPoeng > 3){
    ...
    setTimeout(function(){ location.replace("../../story/story4/index.html"); }, 3000); //Får du mer enn fire poeng blir du sendt videre etter 3 sekund til ny side.
    ...
    setTimeout(function(){ location.replace("../../story/storyTaper/index.html"); }, 3000); //Om brukeren får mindre poeng så kommer den til tap siden.
