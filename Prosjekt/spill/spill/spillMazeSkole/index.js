...
function onKeyDown(event) {
  if (player.row == 14 && player.col == 14) {
    ...
    setTimeout(function(){ window.open("../../story/story3/index.html", "_self"); }, 2500);
  } else {
...
btnMeny.onclick = function onLoad() {
  btnMeny.style.display = "none";
  ...
  var countDownDate = new Date().getTime() + 37000;
  ...
  var x = setInterval(function() {
    ...
    document.getElementById("counter").innerHTML = "Heia deg! Du rakk det innen 35 sekunder!";
    setTimeout(function(){document.getElementById("snakkeBoble").innerHTML = "Puuh! Jeg rakk det ..";}, 100);
    document.getElementById("karakter").src = "../../karakterbilder/tilfreds.png";
        setTimeout(function(){ location.replace("../../story/story3/index.html"); }, 2500);
  ...
  if (distance < 0 && player.row != 14 && player.col != 14) {
    clearInterval(x);
    document.getElementById("counter").innerHTML = "Du rakk ikke prøven ...";
  }

  // Oppdaterer snakkeboblen og karakterbildet
  if (seconds < 0 && player.row != 14 && player.col != 14) {
    document.getElementById("snakkeBoble").innerHTML = "Ånei .. Dette var ikke bra!";
    document.getElementById("karakter").src = "../../karakterbilder/skuffet.png";
    setTimeout(function(){ location.replace("../../story/storyTaper/index.html"); }, 2500);

  }else {
  if (seconds < 23 && seconds > 10 && player.row != 14 && player.col != 14) {
    document.getElementById("snakkeBoble").innerHTML = "Jeg vil ikke komme for sent!";
    document.getElementById("karakter").src = "../../karakterbilder/sint.png";
  } else {
  if (seconds < 10 && player.row != 14 && player.col != 14) {
    document.getElementById("snakkeBoble").innerHTML = "Nå har jeg veldig dårlig tid!";
